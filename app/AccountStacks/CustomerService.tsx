...
import { View, Text, StyleSheet, Image, Pressable, ActivityIndicator, Dimensions, TouchableOpacity, Linking } from 'react-native'
...
const CustomerService = ({ navigation, route }: { navigation: any, route: any }) => {
            ...
            <View>
                <View style={styles.secondDivWrapper}>
                    ...
                    <View>
                        ...
                        <Text style={styles.customSubTitle}>Chat with our team and get solution</Text>
                    </View>
                </View>
                <View style={styles.thirdDivWrapper}>
                    <TouchableOpacity style={styles.chatCusImage} onPress={handlePhonePress}>
